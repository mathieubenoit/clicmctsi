// @(#)codeTDv2Final/AllPixDigitAnimation :$Name:  $:$Id: AllPixDigitAnimation.cpp 49 2014-07-11 12:10:49Z mbenoit $
...
//______________________________________________________________________________
void AllPixDigitAnimation::AddTrack(vector<double> x, vector<double> y, vector<double> z, vector<double> t,double sigma, double energy, int color)
{
...
//              };
    ...
    //cout << TString::Format("[Animation] shift x = %f shift y = %f",shiftx,shifty) << endl;
     ...
     for(uint i=0;i<x.size();++i){
      ...
      Geo->GetTrack(trackid)->SetMarkerColor(color);
      Geo->GetTrack(trackid)->SetLineColor(color);
